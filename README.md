...
**🌐 在线使用 / Live:** [简体](https://jonhendrigiga.github.io/emulator-pc-spec-checker/) · [繁體](https://jonhendrigiga.github.io/emulator-pc-spec-checker/zh-tw/) · [English](https://jonhendrigiga.github.io/emulator-pc-spec-checker/en/) · [日本語](https://jonhendrigiga.github.io/emulator-pc-spec-checker/ja/)
...
配置阈值整理自实测：原神建议 i5+/16G/独显（GTX1060+）；120 帧需「游戏支持 + 模拟器设 120 + 显示器 ≥120Hz」三者同时满足。
